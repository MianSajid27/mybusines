              ...
              <div className="contact-form">
                ...
                <form action="" className='my-5'>
                  <div className="d-flex my-4  mx-4">
                    <input type="text" name="" id="1" placeholder='Fitst Name*' />
                    <input className='con' type="text" name="3" id="2" placeholder='Last Name*' />
                  </div>
                  <div className="d-flex my-4 mx-4">
                    <input type="email" name='' id='3' placeholder='Email Address' />
                    <input className='con' type="number" name='' id='4' placeholder='Phone No' />
                  </div>
                  <textarea className='my-3 p-3 mx-4' name="" id="5" cols="85" rows="6" placeholder='Write Your Message*'></textarea>

                  <a className='mt-3 mx-4 btn-outline ' id='5' href='/'>Send Message</a>
                </form>
              </div>
            </div>
